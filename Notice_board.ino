...
#define AIO_USERNAME    "aazibansari"
#define AIO_KEY         "aio_dQhu57HFh1S3DqzVqvB0EFR3p3G9"
...
void setup()
{
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("Hamza Connect", "Usman157");
  WiFiMulti.addAP("Aazib_Ansari", "engr.aazib1808");
